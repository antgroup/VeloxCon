...
这个仓库包含了历届会议的全部演讲资料，欢迎大家[查阅和下载](./2025/)！本次大会内容默认按照 CC BY-SA 4.0 协议授权组织者进行宣传和传播，如有疑问请联系我们。
...
This repository contains all the presentation materials from the conference. Feel free to [explore and download](./2025/)! The content is licensed under CC BY-SA 4.0 by default for organizers to promote and share. If you have any questions, please contact us.